...
```
travel_recommendations_model        <- Root directory. Both monorepo and polyrepo are supported.
│
├── travel_recommendations_model       <- Contains python code, notebooks and ML assets related to one ML project. 
│   │
...
and [ML asset config guide](travel_recommendations_model/assets/README.md) to propose, test, and deploy changes to production ML code (e.g. update model parameters)
...
| Data Scientist                | Modify production model ML assets, e.g. model training or inference jobs  | [ML asset config guide](travel_recommendations_model/assets/README.md)                                                     |
