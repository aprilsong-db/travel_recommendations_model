...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``travel_recommendations_model/assets/model-workflow-asset.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in travel_recommendations_model/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in travel_recommendations_model/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-travel_recommendations_model-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "asong_dev.travel_demo_demo.travel_recommendations_model", "Full (Three-Level) Model Name")
