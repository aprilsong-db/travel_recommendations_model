...
# ``travel_recommendations_model/assets/model-workflow-asset.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-travel_recommendations_model-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.online.travel_recommendations_model-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.online.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.online.trip_dropoff_features",
