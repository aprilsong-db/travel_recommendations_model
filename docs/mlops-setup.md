...
[ML Config](../travel_recommendations_model/assets/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore travel_recommendations_model/assets/README.md
...
If you want to use different catalog names, please update the targets declared in the [travel_recommendations_model/databricks.yml](../travel_recommendations_model/databricks.yml)
and [travel_recommendations_model/assets/ml-artifacts-asset.yml](../travel_recommendations_model/assets/ml-artifacts-asset.yml)
 files. 
...
Follow the instructions in [travel_recommendations_model/assets/README.md](../travel_recommendations_model/assets/README.md) to deploy ML assets
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML asset config guide](../travel_recommendations_model/assets/README.md)  to propose, test, and deploy
